...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "user_app/home.php";
...
$LoginRS__query=sprintf("SELECT username, password FROM tbl_perus WHERE username=%s",
    GetSQLValueString($loginUsername, "text"),GetSQLValueString($pass, "text"));
   
   $LoginRS = mysql_query($LoginRS__query, $conn) or die(mysql_error());
 $loginFoundUser = mysql_num_rows($LoginRS);
 if ($loginFoundUser) {
  $loginStrGroup = "";
  //list($username,$pass) = mysql_fetch_assoc($LoginRS);
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="javascript:;">Login User Pengguna Jasa</a>
      </div>
      ...
      <div class="collapse navbar-collapse justify-content-end">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="../sipolan2/user_app/home.php" class="nav-link">
              <i class="material-icons">dashboard</i>
              Dashboard
            </a>
          </li>
          <li class="nav-item ">
            <a href="../sipolan2/register.php" class="nav-link">
              <i class="material-icons">person_add</i>
              Register
            </a>
          </li>
          <li class="nav-item  active ">
            <a href="../sipolan2/index.php"class="nav-link">
            ...
            <form ACTION="<?php echo $loginFormAction; ?>" class="form" method="POST">
              <div class="card card-login card-hidden">
                <div class="card-header card-header-rose text-center">
                 <h4 class="card-title">"PELAYANAN PASTI, PASTI CEPAT, PASTI TRANSPARAN DAN PASTI TUNTAS"</h4>
