...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
		...
		if($filesize <= $max_size) {
  		$updateSQL = sprintf("UPDATE vw_sk SET file2bc='$nama_baru', nosurbc=%s, tgl2bc='$tgl', idstts=%s, levbc=%s, idlo=%s WHERE idsur=%s",
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-success card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>KIRIM DATA JAWABAN</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered table-striped"><tbody><tr><td><table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th width="23%">Judul Surat Permohonan</th>
                                    <td width="3%">:</td>
                                    <td width="74%"><?php echo $row_rspe['judul']; ?></td>
                                  </tr>
                                  <tr>
                                    <th>Nomor Surat Jawaban</th>
                                    <td>:</td>
                                    <td><input name="nosurbc" type="text" id="nosurbc" size="50"></td>
                                  </tr>
                                  <tr>
                                    <th>Status Pengajuan</th>
                                    <td>:</td>
                                    <td><input type="radio" name="idstts" id="radio" value="6">
                                    <strong>Selesai</strong></td>
                                  </tr>
                                  <tr>
                                    <th>Upload File</th>
                                    <td>:</td>
                                    <td><input type="file" name="file2bc" id="file2bc"></td>
                                  </tr>
                                  <tr>
