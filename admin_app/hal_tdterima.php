...
$tgl = $_POST['tgl4bc'];
if($_SESSION['MM_UserLevel'] == 'fdpkc' OR ($_SESSION['MM_UserLevel'] == 'fdperbend')){
  $updateSQL = sprintf("UPDATE tbl_surat SET idlo=%s, tgl4bc='$tgl', kett=%s, namabc=%s WHERE idsur=%s",
                       GetSQLValueString($_POST['idlo'], "int"),
					   GetSQLValueString($_POST['kett'], "text"),
					   GetSQLValueString($_POST['namabc'], "text"),
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-success card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Tanda Terima/Penolakan</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered table-striped"><tbody><tr><td><table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  <tr>
                                    <th width="21%"><span class="style3">Nama Perusahaan </span></th>
                                    <td width="4%">:</td>
                                    <td width="75%"><?php echo $row_rspe['namapr']; ?></td>
                                  </tr>
                                        <tr>
                                          <th><span class="style3">Judul Surat</span></th>
                                          <td>:</td>
                                          <td><?php echo $row_rspe['judul']; ?></td>
                                  </tr>
                                        <tr>
                                          <th><span class="style3">Tanggal Kirim Surat</span></th>
                                          <td>:</td>
                                          <td><?php echo $row_rspe['tgl1p']; ?></td>
                                  </tr>
                                        <tr>
                                          <th rowspan="2"><span class="style3"></span> Diterima</th>
                                          <td rowspan="2">:</td>
                                          <td><strong>Keterangan : </strong></td>
                                      </tr>
                                        <tr>
                                          <td><input name="kett" type="text" id="kett" value="<?php echo $row_rspe['kett']; ?>" size="100"></td>
                                        </tr>
                                        <tr>
                                          <th height="42">Ditolak</th>
                                          <td>&nbsp;</td>
                                          <td><a href="ket_reject.php?idsur=<?php echo $row_rspe['idsur']; ?>" class="btn btn-danger btn-xs">Reject</a></td>
                                        </tr>
                                        
                                        <tr>
                                          <th height="42"><span class="style3">Nama Petugas Frontdesk/NIP</span></th>
                                          <td>:</td>
                                          <td><input name="namabc" type="text" id="namabc" value="<?php echo $row_rspe['namabc']; ?>" size="100"></td>
                                      </tr>
                                        <tr>
                                          <th>Tanggal Tanda Terima</th>
                                          <td>:</td>
                                          <td><?php echo $row_rspe['tgl4bc']; ?></td>
                                  </tr>
                                        <tr>
                                          <th><span class="style1"><a href="hal_masuk.php"class="btn btn-info btn-xs">Kembali</a></span></th>
                                          <td>&nbsp;</td>
                                          <td><input type="submit" name="button" id="button" value="ENTER"> <input name="idsur" type="hidden" id="idsur" value="<?php echo $row_rspe['idsur']; ?>"> <input type="hidden" name="tgl4bc" id="tgl4bc" value="<?
                                      $tgl4bc=date ('Y-m-d H:i:s');
									  echo $tgl4bc;
									  ?>">                                   
                                          <input name="levbc" type="hidden" id="levbc" value="<?php echo $row_rspe['levbc']; ?>">
                                          <input name="idlo" type="hidden" id="idlo" value="<?php echo $row_rslog['idlo']; ?>"></td>
                                        </tr>
                                </tbody>
                              </table></td>
                                    </tr>
