...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tbl_login SET password=%s WHERE username1=%s",
  ...
  $updateGoTo = "hal_update_psw_notif.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conn, $conn);
$query_rspsw = "SELECT * FROM tbl_login";
$rspsw = mysql_query($query_rspsw, $conn) or die(mysql_error());
$row_rspsw = mysql_fetch_assoc($rspsw);
$totalRows_rspsw = mysql_num_rows($rspsw);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-warning card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Update Password Anda</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th width="21%">Password old</th>
                                      <td width="2%">:</td>
                                    <td width="77%"><input name="password" type="password" id="password" value="<?php echo $row_rspsw['password']; ?>" size="50"></td>
                                  </tr>
                                  <tr>
                                    <th>New Password</th>
                                    <td>:</td>
                                    <td><input name="password" type="password" id="password" value="<?php echo $row_rspsw['password']; ?>" size="50"></td>
                                  </tr>
                                  <tr>
                                    <th><input name="idlo" type="hidden" id="idlo" value="<?php echo $row_rspsw['idlo']; ?>"> 
                                      <a href="Home.php"class="btn btn-info btn-xs">Kembali</span></a></th>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" name="button" id="button"value="Simpan">
                                    <input name="username1" type="hidden" id="username1" value="<?php echo $row_rspsw['username1']; ?>"></td>
                                    </tr>
                                </tbody>
                              </table>
                            </div>
