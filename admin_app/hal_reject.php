...
if (isset($_SERVER['QUERY_STRING'])) {
  $editFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
	...
	$nama_baru = round(microtime(true)). '.' . end($temp);
  		...
  		$updateSQL = sprintf("UPDATE vw_sk SET idstts=7 WHERE idsur=%s",
                       GetSQLValueString($_GET['idsur'], "int"));
			//echo $updateSQL;
  			mysql_select_db($database_conn, $conn);
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" dhref="hal_perusahaan.php">
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-warning card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Reject Data</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                    <div class="row">
                    ...
                    <div class="panel panel-default">
                       <div class="panel-body">
                          ...
                          Reject Berhasil
                          <h4><a href="hal_masuk.php">kembali</a></h4>
                      </div>
                    </div>
                </div>
            <div class="col-md-12">
