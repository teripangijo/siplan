...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
	  ...
	  $updateSQL = sprintf("UPDATE tbl_surat SET ketd=%s, username=%s WHERE idsur=%s",
                       GetSQLValueString($_POST['ketd'], "text"),
...
mysql_select_db($database_conn, $conn);
$query_rssur = sprintf("SELECT * FROM tbl_surat WHERE idsur = %s", GetSQLValueString($colname_rssur, "int"));
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Keterangan Reject</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
							    ...
							    <table class="table table-bordered table-striped">
							      ...
							      <tbody>
							        ...
							        <tr>
                                      ...
                                      <td>:</td>
                                      <td colspan="2"><input name="ketd" type="text" id="ketd" value="<?php echo $row_rssur['ketd']; ?>" size="100"></td>
                                      </tr>							        
							        <tr>
                                      <td>&nbsp;</td>
                                       <th><span class="style1"><a href="hal_masuk.php"class="btn btn-info btn-xs">Kembali</a></span></th>
                                      <td colspan="2"><input type="submit" name="button" id="button" value="ENTER">
