...
$colname_rsper4 = "-1";
if (isset($_GET['idper'])) {
  $colname_rsper4 = $_GET['idper'];
}
mysql_select_db($database_conn, $conn);
$query_rsper4 = sprintf("SELECT * FROM vw_skep WHERE idper = %s", GetSQLValueString($colname_rsper4, "int"));
$rsper4 = mysql_query($query_rsper4, $conn) or die(mysql_error());
$row_rsper4 = mysql_fetch_assoc($rsper4);
$totalRows_rsper4 = mysql_num_rows($rsper4);
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
                                          <td width="77%"><?php echo $row_rsper4['namapr']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Nama Lengkap (user)</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['namal']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Alamat Perusahaan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['alt']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Email Perusahaan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['email']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>NPWP</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['npwp']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Nama Penanggung Jawab</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['pngjwb']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Jenis SKEP</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['namas']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Nomor SKEP</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['noskep']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>File SKEP</th>
                                          <td>:</td>
                                          <td><a href="../fileskep/<?php echo $row_rsper4['fileskp']; ?>?idper=<?php echo $row_rsper4['idper']; ?>"><?php echo                                          $row_rsper4['fileskp']; ?></a></td>
                                      </tr>
                                        <tr>
                                          <th>Komoditi Bahan Baku</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['kombk']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Komoditi Hasil Produksi</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['komhp']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Status Perusahaan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['namaa']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Tanggal Penginputan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['tgl']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Keterangan </th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper4['ket']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>&nbsp;</th>
                                          <td>&nbsp;</td>
                                          <td><a href="hal_perusahaan.php" class="btn btn-info btn-xs">Kembali</a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                         </div>
