...
$colname_rsper2 = "-1";
if (isset($_GET['idsur'])) {
  $colname_rsper2 = $_GET['idsur'];
}
mysql_select_db($database_conn, $conn);
$query_rsper2 = sprintf("SELECT * FROM vw_sk WHERE idsur = %s", GetSQLValueString($colname_rsper2, "int"));
$rsper2 = mysql_query($query_rsper2, $conn) or die(mysql_error());
$row_rsper2 = mysql_fetch_assoc($rsper2);
$totalRows_rsper2 = mysql_num_rows($rsper2);
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-success card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>DETAIL SURAT MASUK</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                    <div class="row">
                         ...
                         <div class="table-responsive">
                               <table class="table table-bordered table-striped">
                                 <thead>
                                       ...
                                       <tbody>
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
                                          <td colspan="2"><?php echo $row_rsper2['namapr']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Nomor Surat Permohonan</th>
                                          <td>:</td>
                                          <td colspan="2"><span class="style1"><?php echo $row_rsper2['nosur']; ?></span></td>
                                        </tr>
                                        <tr>
                                          <th>Perihal Permohonan</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['judul']; ?></td>
                                      </tr>
                                       <tr>
                                          <th>Janji Layanan</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['layan']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>File surat Permohonan</th>
                                          <td>:</td>
                                          <td width="8%"><a href="../file20p/<?php echo $row_rsper2['file1p']; ?>?idsur=<?php echo $row_rsper2['idsur']; ?>" class="btn btn-warning btn-xs" target="_blank"> Download</a> </td>
                                          <td width="69%"><?php echo $row_rsper2['file1p']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Tanggal kirim Perusahaan</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl1p']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Nomor Surat Jawaban</th>
                                          <td>:</td>
                                          <td colspan="2"><span class="style1"><?php echo $row_rsper2['nosurbc']; ?></span></td>
                                        </tr>
                                        <tr>
                                          <th>File Surat Jawaban</th>
                                          <td>:</td>
                                          <td><a href="../file20bc/<?php echo $row_rsper2['file2bc']; ?>?idsur=<?php echo $row_rsper2['idsur']; ?>" class="btn btn-warning btn-xs" target="_blank">Download</a></td>
                                          <td><?php echo $row_rsper2['file2bc']; ?></td>
                                        </tr>
                                         <tr>
                                          <th>Tanggal Respon Data</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl3bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Terima Data Lengkap</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl4bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Upload Nadine</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl5bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Penelitian</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl6bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Kirim BC</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['tgl2bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Status</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['nama']; ?></td>
                                      </tr>
                                       <tr>
                                          <th>Jangka Waktu</th>
                                          <td>:</td>
									...
									$date1 = date($row_rsper2['tgl4bc']);
									$date2 = date($row_rsper2['tgl2bc']);
								...
								?>     </td>
                                       ...
                                       <tr>
                                          <th>Jangka Waktu(HK)</th>
                                          <td>:</td>
                                          <td colspan="2">
                                              	<?php
								date_default_timezone_set('asia/jakarta');					
								$date1 = explode(" ",$row_rsper2['tgl4bc']);
								$date2 = explode(" ",$row_rsper2['tgl2bc']);
								$date_s = date($date1[0]);
								$date_e = date($date2[0]);
								$i=1;
								$jlh_hari=0;
									...
									?>
                                        ...
                                        <tr>
                                          ...
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['kett']; ?></td>
                                      </tr>
                                      <tr>
                                          <th>Petugas Frontdesk Teliti Kelengkapan</th>
                                          <td>:</td>
                                          <td colspan="2"><?php echo $row_rsper2['namabc']; ?></td>
                                      </tr>
                                <th>&nbsp;</th>
                                <td>&nbsp;</td>
                                <td><a href="hal_keluar.php" class="btn btn-info btn-xs">Kembali</a></td>
                                <td>&nbsp;</td>
                                </tr>
                                </tbody>
                         </table>
