...
{
$query_rspe = "SELECT * FROM vw_sk WHERE idstts=6 ORDER BY idsur DESC";
}
else
{$query_rspe = "SELECT * FROM vw_sk WHERE (idstts=6) AND leveluser='".$_SESSION['MM_UserLevel']."' ORDER BY idsur DESC";}
...
if (isset($_GET['MM_Username'])) {
  $colname_rsbc2 = $_GET['MM_Username'];
}
mysql_select_db($database_conn, $conn);
$query_rsbc2 = sprintf("SELECT * FROM vw_log WHERE username1 = %s", GetSQLValueString($colname_rsbc2, "text"));
$rsbc2 = mysql_query($query_rsbc2, $conn) or die(mysql_error());
$row_rsbc2 = mysql_fetch_assoc($rsbc2);
$totalRows_rsbc2 = mysql_num_rows($rsbc2);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <a class="btn btn-info" target="" href="hal_rekap_data.php"><i class="fa fa-plus"></i> Rekapitulasi Data </a>
                   <a class="btn btn-info" target="" href="exportjkw.php"><i class="fa fa-plus"></i> Export to Excel </a>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr class="bg-info">
                          ...
                          <th><strong>Waktu Kirim</strong></th>
                      ...
                      <tbody>
                        <?php do { ?>
                                      <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $row_rspe['tgl2bc']; ?></td>
                                        <td><?php echo $row_rspe['nama']; ?></td>
                                        <td class="center"><?php echo $row_rspe['leveluser']; ?></td>
                                        <td class="center"><div align="center">
                                        <a href="hal_detail_keluar.php?idsur=<?php echo $row_rspe['idsur']; ?>" class="btn btn-info btn-xs">Detail</a> | 
                                        <a href="../file20bc/<?php echo $row_rspe['file2bc']; ?>?idsur=<?php echo $row_rspe['idsur']; ?>" class="btn btn-primary btn-xs" target="_blank">Download</a> | 
										<?php if($_SESSION['MM_UserLevel'] == 'pkc' OR 'perbend'){ ?>
                                        <a href="Hal_edit.php?idsur=<?php echo $row_rspe['idsur'];   ?>"class="btn btn-success btn-xs"> Edit </a>
                                        <?php } ?> 
										</div>
                                        </td>
                                      </tr>
