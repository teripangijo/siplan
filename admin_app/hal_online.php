...
//echo $_SESSION['MM_UserLevel'];
mysql_select_db($database_conn, $conn);
if($_SESSION['MM_UserLevel'] == 'pli')
{
$query_rstya = "SELECT * FROM tbl_tanya,tbl_perus WHERE tbl_tanya.idper = tbl_perus.idper ORDER BY tbl_tanya.idsul DESC"; 
//echo $query_rstya;
}
else
{$query_rstya = "SELECT * FROM tbl_tanya,tbl_perus WHERE tbl_tanya.idper = tbl_perus.idper AND tbl_tanya.idlo = '".$_SESSION['MM_idlo']."' ORDER BY idsul DESC";}
...
$colname_rspenil = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_rspenil = $_SESSION['MM_Username'];
}
mysql_select_db($database_conn, $conn);
$query_rspenil = sprintf("SELECT * FROM vw_tnp WHERE username = %s", GetSQLValueString($colname_rspenil, "text"));
$rspenil = mysql_query($query_rspenil, $conn) or die(mysql_error());
$row_rspenil = mysql_fetch_assoc($rspenil);
$totalRows_rspenil = mysql_num_rows($rspenil);
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title"><strong>KLInIK Online (Layanan Konsultasi Online)</strong></h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0%" width="100%" style="width:100%">
                      <thead>
                        <tr class="bg-info">
                          <th></th>
                            <th width="15%"><strong>Nama Perusahaan</strong></th>
                            <th width="20%"><strong>Pertanyaan</strong></th>
                            <th width="13%"><strong>Tgl Kirim</strong></th>
                            <th width="20%"><strong>Jawaban</strong></th>
                            <th width="12%"><strong>Tgl Respon</strong></th>
                      ...
                      <tbody>
                         <?php do { ?>
								<?php
									...
									$tgl1 = date_create($row_rstya['tglt']);
								...
								?>
                                  <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $row_rstya['namapr']; ?></td>
                                    <td><?php echo $row_rstya['dtya']; ?></td>
                                    <td><?php echo $row_rstya['tglt']; ?></td>
                                    <td><?php echo $row_rstya['jawb']; ?>
                                    <?php 									
											if(($tglxx <= $now) AND (empty($row_rstya['jawb']))) 
											{echo "<img src=warning.gif width='30px'>";}
										?>
                                    </td>
                                    <td class="center"><?php echo $row_rstya['tglj']; ?></td>
                                    <td class="center">
									<?php if(empty($row_rstya['jawb'])){ ?>
									<a href="hal_balasan.php?idsul=<?php echo $row_rstya['idsul']; ?>" class="btn btn-info btn-xs">Balas</a>
									<?php } else { ?>
                                     <a href="#" class="btn btn-success btn-xs">Selesai</a>	
									<?php } ?> 
                                     | <a href="hal_detail_online.php?idsul=<?php echo $row_rstya['idsul']; ?>" class="btn btn-warning btn-xs">Detail</a>|
									<?php if(empty($row_rstya['jawb'])){ ?>		
                                    <?php if ($_SESSION['MM_UserLevel'] == 'pli'):?> 
                                    <a href="hal_distribusi.php?idsul=<?php echo $row_rstya['idsul']; ?>"class="btn btn-primary btn-xs">Distribusi</a><?php endif; ?></td>
									<?php } ?>
								  </tr>
                                    <?php } while ($row_rstya = mysql_fetch_assoc($rstya)); ?>
</tbody>
                            </table>
                  </div>
                </div>
