...
$query_rsper = "SELECT * FROM tbl_perus ORDER BY idper DESC";
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr class="bg-info">
                          ...
                          <th><strong>Nama Penanggung Jawab</strong></th>
                      ...
                      <?php do { ?>
                                      <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $row_rsper['pngjwb']; ?></td>
                                        <td><?php echo $row_rsper['npwp']; ?></td>
                                        <td><?php echo $row_rsper['telp']; ?></td>
                                        <td class="center"><div align="center"><a href="Hal_Detail_Perusahaan.php?idper=<?php echo $row_rsper['idper']; ?>" class="btn btn-warning btn-xs">Detail</a></div></td>
                                      </tr>
