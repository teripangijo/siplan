...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tbl_perus SET username=%s, password=%s WHERE idper=%s",
...
if (isset($_SESSION['MM_Username'])) {
  $colname_rspsw = $_SESSION['MM_Username'];
}
mysql_select_db($database_conn, $conn);
$query_rspsw = sprintf("SELECT * FROM tbl_perus WHERE username = %s", GetSQLValueString($colname_rspsw, "text"));
        ...
        <div class="user">
          ...
          <div class="user-info">
            <a data-toggle="collapse" href="#collapseExample" class="username">
              <span>
                <strong>Welcome, <?php echo $row_rspsw['username1']; ?></strong>
                <b class="caret"></b>
              </span>
            </a>
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th>
									<p>Password Telah Berhasil Diubah, </p>
