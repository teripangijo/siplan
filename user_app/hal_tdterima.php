...
mysql_select_db($database_conn, $conn);
$query_rspe = sprintf("SELECT * FROM vw_rek WHERE idsur = %s", GetSQLValueString($colname_rspe, "int"));
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td><?php echo $row_rspe['kett']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Keterangan Ditolak</th>
                                          <td>:</td>
                                          <td><?php echo $row_rspe['ketd']; ?></td>
                                      </tr>
                                        <tr>
                                          <th>Nama Petugas Frontdesk/NIP</th>
                                          <td>:</td>
                                          <td><?php echo $row_rspe['namabc']; ?></td>
                                      </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td> <a class="btn btn-info" target="" href="hal_surat_masuk.php"></i> Kembali </a></td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        </tr>
                                    </tbody>
