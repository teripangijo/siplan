                  ...
                  <div class="card-header card-header-warning card-header-icon">
                    <div class="card-icon">
                     ...
                     <?php
								...
								$jumlahkan = "SELECT COUNT(idstts) AS jumlah_total FROM tbl_surat where idstts=1 and thn = '$thn_sekarang'and username='".$row_rsper['username']."'"; //perintah untuk menjumlahkan
                  ...
                  <div class="card-header card-header-rose card-header-icon">
                    <div class="card-icon">
                      ...
                      <?php
								...
								$jumlahkan = "SELECT COUNT(idstts) AS jumlah_total FROM tbl_surat where idstts=5 and thn = '$thn_sekarang' and username='".$row_rsper['username']."'"; //perintah untuk menjumlahkan
                    ...
                    <div class="card-icon">
                      <i class="material-icons">folder</i></div>
                       <?php
								...
								$jumlahkan = "SELECT COUNT(idstts) AS jumlah_total FROM tbl_surat where idstts=6 and thn = '$thn_sekarang' and username='".$row_rsper['username']."'"; //perintah untuk menjumlahkan
								...
								?>
                    <p class="card-category"><strong>SURAT SELESAI</strong></p>
                    <h3 class="card-title"><?php echo "<b>" . number_format($t['jumlah_total']) . " </b>"; ?></h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                  ...
                  <div class="card-header card-header-warning card-header-icon">
                    <div class="card-icon">
                      ...
                      <?php
								...
								$jumlahkan = "SELECT COUNT(idpsn) AS jumlah_total FROM tbl_tanya where idpsn=1 and thn = '$thn_sekarang' and username='".$row_rsper['username']."'"; //perintah untuk menjumlahkan
								...
								?>    
                    <p class="card-category"><strong>KLInIK ONLINE</strong></p>
                    <h3 class="card-title"><?php echo "<b>" . number_format($t['jumlah_total']) . " </b>"; ?></h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
