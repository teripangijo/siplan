...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateSQL = sprintf("DELETE FROM tbl_surat WHERE idsur=%s",
...
//echo $updateSQL;
  ...
  $updateGoTo = "update_pass_sukses.php";
  if (isset($_SERVER['QUERY_STRING'])) {
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><a href="hal_surat_keluar.php">Back Menu</a><strong></strong></h4>
                  </div>
                </div>
                <div class="card-body ">
