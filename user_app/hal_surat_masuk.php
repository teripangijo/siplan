...
mysql_select_db($database_conn, $conn);
$query_rsper = sprintf("SELECT * FROM vw_sk WHERE (idstts = 6) AND username = %s ORDER BY idsur DESC", GetSQLValueString($colname_rsper, "text"));
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr class="bg-info">
                          ...
                          <th><strong>Surat Jawaban</strong></th>
                          <th><strong>Tgl Surat Masuk</strong></th>
                      ...
                      <?php do { ?>
                                      <tr class="odd gradeX">
                                        ...
                                        <td class="center"><?php echo $row_rsper['nosurbc']; ?></td>
                                        <td class="center"><?php echo $row_rsper['tgl1p']; ?></td>
                                        <td class="center"><?php echo $row_rsper['nama']; ?></td> <?php if(($row_rsper['idstts'] == 6)):?> 
                                        <td class="center"> <div align="center"><a href="../file20bc/<?php echo $row_rsper['file2bc']; ?>?idsur=<?php echo $row_rsper['idsur']; ?>" class="btn btn-primary btn-xs" target="_blank">Download</a>|<a href="hal_tdterima.php?idsur=<?php echo $row_rsper['idsur']; ?>"class="btn btn-success btn-xs">Tanda Terima/Tolak</a></div></td><?php endif; ?>
                                    </tr>
