...
mysql_select_db($database_conn, $conn);
$query_rsper = sprintf("SELECT * FROM vw_sk WHERE username = %s and (idstts!=6) ORDER BY idsur DESC", GetSQLValueString($colname_rsper, "text"));
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <a class="btn btn-info" target="" href="in_suratkeluar.php"><i class="fa fa-plus"></i> Tambah Data </a><br>
                  </div>
                <div class="card-body">
                  <div class="toolbar">
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr class="bg-info">
                          ...
                          <th><strong>Judul Surat</strong></th>
                      ...
                      <tbody>
                       <?php do { ?>
                                      <tr class="odd gradeX">
                                        <td><div align="center"><?php echo $b=$b+1;?></div></td>
                                        <td><?php echo $row_rsper['namapr']; ?></td>
                                        <td><?php echo $row_rsper['nosur']; ?></td>
                                        <td><?php echo $row_rsper['judul']; ?></td>
                                        <td class="center"><?php echo $row_rsper['tgl1p']; ?></td>
                                        <td class="center"><?php echo $row_rsper['nama']; ?></td>
                                       <td class="center"><div align="center">
<?php if($row_rsper['idstts'] == 1): ?>
<a href="hal_editp.php?idsur=<?php echo $row_rsper['idsur']; ?>" class="btn btn-info btn-xs">Edit</a> | 
<?php endif; ?>
<?php if($row_rsper['idstts'] == 1 OR $row_rsper['idstts'] == 7): ?>
<a href="hal_deletep.php?idsur=<?php echo $row_rsper['idsur']; ?>" class="btn btn-warning btn-xs">Delete</a> | 
<?php endif; ?>
<a href="hal_detail_keluar.php?idsur=<?php echo $row_rsper['idsur']; ?>" class="btn btn-success btn-xs">Detail</a> | 
<a href="../file20p/<?php echo $row_rsper['file1p']; ?>?idsur=<?php echo $row_rsper['idsur']; ?>" class="btn btn-primary btn-xs" target="_blank">Download</a></div>
									</td>
                                    </tr>
