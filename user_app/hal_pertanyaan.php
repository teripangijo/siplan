...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tbl_tanya (idper, idpsn, dtya, tglt, thn, idlo, username) VALUES (%s, %s, %s, '$tgl', %s, %s, %s)",
...
mysql_select_db($database_conn, $conn);
$query_rstj = "SELECT * FROM tbl_tuju";
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-success card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Tambah Pertanyaan</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                              ...
                              <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>:</td>
                                    <td><?php echo $row_rsper['namapr']; ?></td>
                                  </tr>

                                  <tr>
                                    <th width="21%">Pertanyaan</th>
                                    <td width="2%">:</td>
                                    <td width="77%"><textarea name="dtya" cols="100" id="dtya"></textarea></td>
									<input type="hidden" name="idlo" id="idlo" value="<?php echo $row_rstj['idlo']?>">
                                  </tr>
                                  <tr>
                                    <td> <a class="btn btn-info" target="" href="hal_online.php"></i> Kembali </a></td>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" name="button" id="button" value="Kirim">
                                      <input name="idper" type="hidden" id="idper" value="<?php echo $row_rsper['idper']; ?>">
                                      <input type="hidden" name="tglt" id="tglt" value="<?
                                      $tglt=date ('Y-m-d H:i:s');
									  echo $tglt;
									  ?>">
                                      <input name="thn" type="hidden" id="thn" value="<?php echo $row_rsthn['thn']; ?>">
                                      <input name="username" type="hidden" id="username" value="<?php echo $row_rsper['username']; ?>">
...
mysql_free_result($rsjns);
mysql_free_result($rsper);
mysql_free_result($rsthn);
mysql_free_result($rspsn);
