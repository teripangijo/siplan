...
mysql_select_db($database_conn, $conn);
$query_rslog = sprintf("SELECT * FROM tbl_perus WHERE username = %s", GetSQLValueString($colname_rslog, "text"));
        ...
        <div class="user">
          ...
          <div class="user-info">
            <a data-toggle="collapse" href="#collapseExample" class="username">
              <span>
               <strong>Welcome, <?php echo $row_rslog['username']; ?></strong>
                <b class="caret"></b>
              </span>
            </a>
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-info card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Data Janji Layanan</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                 <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th width="6%">No</th>
                                        <th width="43%">Janji Layanan</th>
                                      <th width="8%">Tahun Update</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php do { ?>
                                      <tr class="odd gradeX">
                                        <td><div align="center"><?php echo $j=$j+1;?></div></td>
                                        <td><?php echo $row_rslay['layan']; ?></td>
                                        <td class="center"><?php echo $row_rslay['thn']; ?></td>
                                      </tr>
                                      <?php } while ($row_rslay = mysql_fetch_assoc($rslay)); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
