...
if (isset($_SESSION['MM_Username'])) {
  $colname_rstyap = $_SESSION['MM_Username'];
}
mysql_select_db($database_conn, $conn);
$query_rstyap = "SELECT * FROM tbl_tanya,tbl_perus WHERE tbl_tanya.idper = tbl_perus.idper ORDER BY tbl_tanya.idsul DESC"; 
...
mysql_select_db($database_conn, $conn);
$query_rspenil = sprintf("SELECT * FROM vw_tnyap WHERE username = %s", GetSQLValueString($colname_rspenil, "text"));
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <a class="btn btn-info" target="" href="hal_pertanyaan.php"><i class="fa fa-plus"></i> Tambah Pertanyaan </a><br>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0%" width="100%" style="width:100%">
                      ...
                      <?php do { ?>
                                  <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $row_rstyap['namapr']; ?></td>
                                    <td><?php echo $row_rstyap['dtya']; ?></td>
                                    <td><?php echo $row_rstyap['tglt']; ?></td>
                                    <td class="center"><?php echo $row_rstyap['jawb']; ?></td>
                                    <td class="center"><?php echo $row_rstyap['tglj']; ?></td>
                                    <td class="center">
                                    <div align="left">
     <?php if(empty($row_rstyap['idkul'])){ ?>
	 <a href="hal_nilai_sul.php?idsul=<?php echo $row_rstyap['idsul']; ?>" class="btn btn-info btn-xs">Kepuasan Layanan</a>
	 <?php } else { ?>
     <a href="#" class="btn btn-success btn-xs">Selesai</a>	
	 <?php } ?>
     <a href="hal_detail_online.php?idsul=<?php echo $row_rstyap['idsul']; ?>"class="btn btn-warning btn-xs">Detail</a></div></td>
                                  </tr>
                                    <?php } while ($row_rstyap = mysql_fetch_assoc($rstyap)); ?>
                             </tbody>
                            </table>
                  </div>
                </div>
