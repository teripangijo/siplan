                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th width="21%">Password old</th>
                                      <td width="2%">:</td>
                                    <td width="77%"><input name="password" type="password" id="password" value="<?php echo $row_rsper['password']; ?>" size="50">                                    </td>
                                  </tr>
                                  <tr>
                                    <th>New Password</th>
                                    <td>:</td>
                                    <td><input name="password" type="password" id="password" value="<?php echo $row_rsper['password']; ?>" size="50"></td>
                                  </tr>
                                  <tr>
                                    <th><a href="Home.php"class="btn btn-info btn-xs">Kembali</span></a></th>
                                    <td>&nbsp;</td>
