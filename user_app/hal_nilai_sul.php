...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tbl_tanya SET idkul=%s, ket=%s, idlo=%s, username=%s WHERE idsul=%s",
                       GetSQLValueString($_POST['idkul'], "int"),
...
$colname_rstyap = "-1";
if (isset($_GET['idsul'])) {
  $colname_rstyap = $_GET['idsul'];
}
mysql_select_db($database_conn, $conn);
$query_rstyap = sprintf("SELECT * FROM vw_tnyap WHERE idsul = %s", GetSQLValueString($colname_rstyap, "int"));
$rstyap = mysql_query($query_rstyap, $conn) or die(mysql_error());
$row_rstyap = mysql_fetch_assoc($rstyap);
$totalRows_rstyap = mysql_num_rows($rstyap);

mysql_select_db($database_conn, $conn);
$query_rstj = "SELECT * FROM vw_tuju";
$rstj = mysql_query($query_rstj, $conn) or die(mysql_error());
$row_rstj = mysql_fetch_assoc($rstj);
$totalRows_rstj = mysql_num_rows($rstj);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="user">
          ...
          <div class="user-info">
            <a data-toggle="collapse" href="#collapseExample" class="username">
              <span>
               <strong>Welcome, <?php echo $row_rstyap['username']; ?></strong>
                <b class="caret"></b>
              </span>
            </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="formsExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="../admin_app/hal_online.php">
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-success card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Penilaian Kepuasan Layanan</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                          ...
                          <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                              <tr class="odd gradeX">
                                ...
                                <td>:</td>
                                <td><?php echo $row_rstyap['dtya']; ?></td>
                              </tr>
                              <tr class="odd gradeX">
                                <td width="20%"><strong>Jawaban</strong></td>
                                <td width="2%">:</td>
                                <td width="78%"><?php echo $row_rstyap['jawb']; ?></td>
                              </tr>
                              <tr class="odd gradeX">
                                <td><strong>Penilaian anda</strong></td>
                                <td>:</td>
                                <td>
                                  <input type="radio" name="idkul" id="radio" value="1">
                                <strong>Sangat Baik</strong>
                                <input type="radio" name="idkul" id="radio2" value="2">
                                <strong>Baik</strong> 
                                  <input type="radio" name="idkul" id="radio3" value="3">
                                 <strong> Buruk </strong>
                                  <input type="radio" name="idkul" id="radio4" value="4">
                                <strong>Sangat Buruk</strong></td>
                              </tr>
                              <tr class="odd gradeX">
                                <td><strong>Ditujukan ke Unit/Seksi</strong></td>
                                <td>:</td>
                                <td><?php echo $row_rstyap['namak']; ?></td>
                              </tr>
                              <tr class="odd gradeX">
                                <td><span class="style1"><a href="hal_online.php"class="btn btn-warning btn-xs">Kembali</a></span></td>
                                <td>&nbsp;</td>
                                <td><input type="submit" name="button" id="button"class="btn btn-info btn-xs"value="Kirim"> <input name="idsul" type="hidden" id="idsul" value="<?php echo $row_rstyap['idsul']; ?>">
                                <input name="idlo" type="hidden" id="idlo" value="<?php echo $row_rstyap['idlo']; ?>">
                                <input name="username" type="hidden" id="username" value="<?php echo $row_rstyap['username']; ?>">
...
mysql_free_result($rstyap);

mysql_free_result($rstj);
