...
$colname_rsper1 = "-1";
if (isset($_GET['idsur'])) {
  $colname_rsper1 = $_GET['idsur'];
}
mysql_select_db($database_conn, $conn);
$query_rsper1 = sprintf("SELECT * FROM vw_sk WHERE idsur = %s", GetSQLValueString($colname_rsper1, "int"));
$rsper1 = mysql_query($query_rsper1, $conn) or die(mysql_error());
$row_rsper1 = mysql_fetch_assoc($rsper1);
$totalRows_rsper1 = mysql_num_rows($rsper1);
?>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td width="2%">:</td>
                                            <td width="77%"><?php echo $row_rsper1['namapr']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Judul Permohonan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['judul']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Janji Layanan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['layan']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>File Surat</th>
                                          <td>:</td>
                                          <td><a href="../file20p/<?php echo $row_rsper1['file1p']; ?>?idsur=<?php echo $row_rsper1['idsur']; ?>"><?php echo $row_rsper1['file1p']; ?></a></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal kirim</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['tgl1p']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>status</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['nama']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Respon Data</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['tgl3bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Terima Data Lengkap</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['tgl4bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Upload Nadine</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['tgl5bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Tanggal Penelitian</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['tgl6bc']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Keterangan Diterima</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['kett']; ?></td>
                                        </tr>
                                        <tr>
                                          <th>Petugas Frontdesk Teliti Kelengkapan</th>
                                          <td>:</td>
                                          <td><?php echo $row_rsper1['namabc']; ?></td>
                                        </tr>
