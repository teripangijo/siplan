...
mysql_select_db($database_conn, $conn);
$query_rstya = sprintf("SELECT * FROM vw_tnyap WHERE idsul = %s", GetSQLValueString($colname_rstya, "int"));
...
mysql_select_db($database_conn, $conn);
$query_rsnil = "SELECT * FROM vw_online";
$rsnil = mysql_query($query_rsnil, $conn) or die(mysql_error());
$row_rsnil = mysql_fetch_assoc($rsnil);
$totalRows_rsnil = mysql_num_rows($rsnil);

$colname_rsjlh = "-1";
if (isset($_GET['idsul'])) {
  $colname_rsjlh = $_GET['idsul'];
}
mysql_select_db($database_conn, $conn);
$query_rsjlh = sprintf("SELECT * FROM vw_jlh WHERE idsul = %s", GetSQLValueString($colname_rsjlh, "int"));
$rsjlh = mysql_query($query_rsjlh, $conn) or die(mysql_error());
$row_rsjlh = mysql_fetch_assoc($rsjlh);
$totalRows_rsjlh = mysql_num_rows($rsjlh);

$colname_rshsl = "-1";
if (isset($_GET['idsul'])) {
  $colname_rshsl = $_GET['idsul'];
}
mysql_select_db($database_conn, $conn);
$query_rshsl = sprintf("SELECT * FROM vw_penilai WHERE idsul = %s", GetSQLValueString($colname_rshsl, "int"));
$rshsl = mysql_query($query_rshsl, $conn) or die(mysql_error());
$row_rshsl = mysql_fetch_assoc($rshsl);
$totalRows_rshsl = mysql_num_rows($rshsl);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="user">
          ...
          <div class="user-info">
            <a data-toggle="collapse" href="#collapseExample" class="username">
              <span>
               <strong>Welcome, <?php echo $row_rstya['username']; ?></strong>
                <b class="caret"></b>
              </span>
            </a>
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-warning card-header-text">
                  <div class="card-text">
                    <h4 class="card-title"><strong>Data Detail KLInIK Online</strong></h4>
                  </div>
                </div>
                <div class="card-body ">
                            ...
                            <table class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td width="2%">:</td>
                                  <td width="77%"><?php echo $row_rstya['namapr']; ?></td>
                                </tr>
                                <tr>
                                  <th>Tujuan Unit Konsultasi</th>
                                  <td>:</td>
                                  <td><?php echo $row_rstya['namak']; ?></td>
                                </tr>
                                <tr>
                                  <th>Pertanyaan</th>
                                  <td>:</td>
                                ...
                                <tr>
                                  <th>Jawaban</th>
                                  <td>:</td>
                                  <td><?php echo $row_rstya['jawb']; ?></td>
                                </tr>
                                <tr>
                                  <th>Tanggal Jawaban</th>
                                  <td>:</td>
                                  <td><?php echo $row_rstya['tglj']; ?></td>
                                </tr>
                                <tr>
                                  <th>Jangka waktu </th>
                                  <td>:</td>
								  ...
								  <?php	
									date_default_timezone_set('asia/jakarta');				
									$date1 = date($row_rstya['tglt']);
									$date2 = date($row_rstya['tglj']);
                                ...
                                <tr>
                                  <th>Status Tingkat Kepuasan</th>
                                  <td>:</td>
                                  <td><?php echo $row_rshsl['namast']; ?></td>
                                </tr>
                                <tr>
                                  <td> <a class="btn btn-info" target="" href="hal_online.php"></i> Kembali </a></td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
                              </tbody>
...
mysql_free_result($rsnil);

mysql_free_result($rsjlh);

mysql_free_result($rshsl);
